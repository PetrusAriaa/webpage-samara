          ...
          <div className="flex flex-col gap-8 px-4">
            <div className="flex flex-col items-center justify-center gap-2">
              <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M23.5264 19.7775L23.5264 29.4567" stroke="#0071B7" strokeWidth="2" stroke-linecap="round"/>
                <path d="M26.3719 22.3581H20.6805" stroke="#0071B7" strokeWidth="2" stroke-linecap="round"/>
              </svg>
          ...
          <div className="flex flex-col gap-8 px-4">
            <div className="flex flex-col items-center justify-center gap-2">
              <svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M30.4983 21.3826H37.4983" stroke="white" strokeWidth="2" stroke-linecap="round"/>
                <path d="M14.5087 21.3826H21.5087" stroke="white" strokeWidth="2" stroke-linecap="round"/>
                ...
                <path d="M26.0034 25.8774L26.0034 38.3235" stroke="white" strokeWidth="2" stroke-linecap="round"/>
                <path d="M26.0034 9.88782L26.0034 16.8878" stroke="white" strokeWidth="2" stroke-linecap="round"/>
